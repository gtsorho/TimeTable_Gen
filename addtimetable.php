...
if (isset($_POST['addtimetable'])) {
  ...
  if ($num_rows > 0){
    echo "<script>alert('Timeslot is already reserved for other Courses.')</script>";
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form id="timetable_form" action="addtimetable.php" method="post">
        <div>
          ...
          <p id="subjectErr" class="text-danger ms-4" style="margin-left:15px"></p>
          <div class="row">
        ...
        function ajaxRequest(type, data) {
          $.ajax({
            ...
            success: function(result) {
              ...
              if(result.length === 2){
                $('#subjectErr').text('No Courses found for the selected programme and semester(Add Course)')
                $('#subjectErr').fadeOut(8000)
              }
              switch (type) {
                case "Subjects":
